...
static int ReverbHICreate(AXFX_REVHI_WORK* rv, f32 coloration, f32 time, f32 mix, f32 damping,
                          f32 preDelay, f32 crosstalk);
static int ReverbHIModify(AXFX_REVHI_WORK* rv, f32 coloration, f32 time, f32 mix, f32 damping,
                          f32 preDelay, f32 crosstalk);
                          ...
                          f32 preDelay, f32 crosstalk)
{
    ...
    ASSERTMSGLINE(105,
                  coloration >= 0.0f && coloration <= 1.0f && time >= 0.01f && time <= 10.0f &&
...
asm static void DoCrossTalk(register s32* l, register s32* r, register f32 cross,
                            register f32 invcross)
{
    nofralloc stwu r1, -48(r1)stfd f14, 40(r1)lis r5, i2fMagic @ha lfd f0, i2fMagic @l(r5) lis r5,
        ...
        cross, invcross lis r5, value1_0 @ha lfs f5, value1_0 @l(r5) li r5, 79 mtctr r5 li r10,
...
asm static void HandleReverb(register s32* sptr, register AXFX_REVHI_WORK* rv, register s32 k)
{
    nofralloc stwu r1, -0xc0(r1)stmw r14, 0x8(r1)stfd f14, 0x60(r1)stfd f15, 0x68(r1)stfd f16,
        ...
        value0_6 @ha lfs f9, value0_6 @l(r31) lis r31, i2fMagic @ha lfd f5, i2fMagic @l(r31) lfs f2,
        AXFX_REVHI_WORK.allPassCoeff(rv) lfs f15, AXFX_REVHI_WORK.damping(rv) lfs f8,
        AXFX_REVHI_WORK.level(rv) fmuls f3, f8, f9 fsubs f4, f9, f3 slwi r30, k, 1 add r30, r30,
        k mulli r31, r30, 0x14 addi r29, rv, AXFX_REVHI_WORK.C add r29, r29, r31 addi r27, rv,
        AXFX_REVHI_WORK.AP add r27, r27, r31 slwi r31, r30, 2 add r31, r31, rv lfs f22,
        AXFX_REVHI_WORK.combCoef[0](r31) lfs f23, AXFX_REVHI_WORK.combCoef[1](r31) lfs f24,
        AXFX_REVHI_WORK.combCoef[2](r31) slwi r31, k, 2 add r31, r31, rv lfs f25,
        AXFX_REVHI_WORK.lpLastout[0](r31) lwz r31, AXFX_REVHI_WORK.preDelayTime(rv) lis r30,
        0x4330 stw r30, 0x58(r1)subi r22, r31, 1 slwi r22, r22, 2 slwi r28, k, 2 add r28, r28,
        rv cmpwi cr7, r31, 0 lwz r21,
        ...
        AXFX_REVHI_DELAYLINE.lastOutput + 0x28(r29) // C[2]
            lwz r25,
        AXFX_REVHI_DELAYLINE.length + 0x00(r29) // C[0]
            lwz r24,
        AXFX_REVHI_DELAYLINE.length + 0x14(r29) // C[1]
            lwz r23,
        AXFX_REVHI_DELAYLINE.length + 0x28(r29) // C[2]
            lwz r4,
        AXFX_REVHI_DELAYLINE.inputs + 0x00(r29) // C[0]
            lwz r5,
        AXFX_REVHI_DELAYLINE.inputs + 0x14(r29) // C[1]
            lwz r6,
        AXFX_REVHI_DELAYLINE.inputs + 0x28(r29) // C[2]
            lwz r12,
        ...
        AXFX_REVHI_DELAYLINE.lastOutput + 0x28(r27) // AP[2]
            lwz r15,
        AXFX_REVHI_DELAYLINE.length + 0x00(r27) // AP[0]
            lwz r14,
        AXFX_REVHI_DELAYLINE.length + 0x14(r27) // AP[1]
        ...
        159 mtctr r31 L_00000964 : fmr f13,
                                   f12 beq cr7,
                                   L_00000994 lwz r30,
                                   AXFX_REVHI_WORK.preDelayLine(r28) lwz r29,
                                   AXFX_REVHI_WORK.preDelayPtr(r28) add r31,
                                   r22,
                                   r30 addi r29,
                                   r29,
                                   4 lfs f13,
                                   -4(r29)cmpw r29,
                                   r31 stfs f12,
                                   -4(r29)bne + L_00000990 mr r29,
                                   r30 L_00000990
        : stw r29,
          AXFX_REVHI_WORK.preDelayPtr(r30) L_00000994 : fmadds f8,
          f22,
          f16,
          f13 lwzu r29,
          4(r3)fmadds f9,
          ...
          f17 cmpw cr6,
          r18,
          r24 bne + L_000009E0 li r21,
          0 L_000009E0 : fmadds f8,
                         f24,
                         f18,
                         f13 bne + cr1,
                         L_000009EC li r20,
                         0 L_000009EC : stfsx f8,
                                        r6,
                                        r17 addi r17,
                                        r17,
                                        4 bne + cr5,
                                        L_000009FC li r19,
                                        0 L_000009FC : lfsx f18,
                                                       r6,
                                                       r16 addi r16,
                                                       r16,
                                                       4 cmpw r17,
        ...
        : fadds f14,
          ...
          r16,
          r23 lwz r26,
          AXFX_REVHI_DELAYLINE.inputs(r27) fmadds f9,
          f2,
          f19,
          f14 bne + L_00000A28 li r17,
          0 L_00000A28 : bne + cr1,
          L_00000A30 li r16,
          0 L_00000A30 : xoris r29,
                         r29,
                         0x8000 stfsx f9,
                         r26,
                         r12 fnmsubs f14,
                         ...
                         r11,
                         4 lwz r26,
                         AXFX_REVHI_DELAYLINE.inputs + 0x14(r27)cmpw cr6,
                         r11,
                         r15 fmadds f8,
                         f2,
                         f20,
                         ...
                         0x0 L_00000A60 : stw r29,
                                          ...
                                          0 L_00000A78 : lfsx f20,
                                                         ...
                                                         f15,
                                                         f25,
                                                         f14 bne + L_00000A9C li r10,
                                                         0 L_00000A9C
        : lwz r26,
          AXFX_REVHI_DELAYLINE.inputs + 0x28(r27)fmadds f9,
          f2,
          f21,
          f14 fmr f25,
          f14 bne + cr1,
          L_00000AB0 li r9,
          0 L_00000AB0 : stfsx f9,
                         r26,
                         r8 fnmsubs f14,
                         f2,
                         f9,
                         f21 lwz r31,
                         AXFX_REVHI_DELAYLINE.length + 0x28(r27)fmuls f8,
                         f4,
                         f12 lfsx f21,
                         r26,
                         r7 addi r8,
                         ...
                         0 L_00000AEC : li r31,
                                        ...
                                        -4(r29)cmpw r29,
                                        r31 stfs f12,
                                        -4(r29)bne + L_00000B28 mr r29,
                                        r30 L_00000B28
        : stw r29,
          AXFX_REVHI_WORK.preDelayPtr(r30) L_00000B2C : fmadds f8,
          f22,
          f16,
          f13 fmadds f9,
          f23,
          ...
          f17 cmpw cr6,
          r18,
          r24 bne + L_00000B74 li r21,
          0 L_00000B74 : fmadds f8,
                         f24,
                         f18,
                         f13 bne + cr1,
                         L_00000B80 li r20,
                         0 L_00000B80 : stfsx f8,
                                        r6,
                                        r17 addi r17,
                                        r17,
                                        4 bne + cr5,
                                        L_00000B90 li r19,
                                        0 L_00000B90 : lfsx f18,
                                                       r6,
                                                       r16 addi r16,
                                                       r16,
                                                       4 cmpw r17,
        ...
        : fadds f14,
          ...
          f2,
          f19,
          f14 bne + L_00000BBC li r17,
          0 L_00000BBC : bne + cr1,
          L_00000BC4 li r16,
          0 L_00000BC4 : stfsx f9,
                         r26,
                         r12 fnmsubs f14,
                         f2,
                         f9,
                         ...
                         0 L_00000BF0 : stfsx f8,
                                        ...
                                        0 L_00000C04 : lfsx f20,
                                                       ...
                                                       f15,
                                                       f25,
                                                       f14 bne + L_00000C24 li r10,
                                                       0 L_00000C24
        : lwz r26,
          AXFX_REVHI_DELAYLINE.inputs + 0x28(r27)lwz k,
          0x50(r1)lwz rv,
          0x54(r1)fmadds f9,
          f2,
          f21,
...
int AXFXReverbHiInit(AXFX_REVERBHI* rev)
{
    ...
    rev->tempDisableFX = 0;
    ret = ReverbHICreate(&rev->rv, rev->coloration, rev->time, rev->mix, rev->damping,
                         rev->preDelay, rev->crosstalk);
...
int AXFXReverbHiSettings(AXFX_REVERBHI* rev)
{
    ...
    old = OSDisableInterrupts();
    rev->tempDisableFX = 1;
    ret = ReverbHIModify(&rev->rv, rev->coloration, rev->time, rev->mix, rev->damping,
                         rev->preDelay, rev->crosstalk);
    rev->tempDisableFX = 0;
    OSRestoreInterrupts(old);
    return ret;
...
void AXFXReverbHiCallback(AXFX_BUFFERUPDATE* bufferUpdate, AXFX_REVERBHI* reverb)
{
    ...
    {
        ReverbHICallback(bufferUpdate->left, bufferUpdate->right, bufferUpdate->surround,
                         &reverb->rv);
    }
}
